...
async def test_google_auth__login_not_exist_user(auth_service: AuthService, get_db_session):
    code = "fake_code"
...
async def test_google_auth__login_exist_user(auth_service: AuthService, get_db_session):
